...
public class PropertySpecification {
  ...
  public static Specification<PropertyEntity> withDynamicQuery(String type, Integer minBedrooms, Integer maxPrice,
      Integer minBathrooms, Double maxSquareMeters) {
