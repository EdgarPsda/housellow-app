...
public class PropertyService {
  ...
  public PropertyEntity findPropertyById(Long id) {
    return propertyRepository.findById(id)
        .orElseThrow(() -> new ResourceNotFoundException("Property not found", "404", HttpStatus.NOT_FOUND));
  }
  ...
  // Advanced search
  @SuppressWarnings("null")
  public List<PropertyEntity> advancedSearch(String type, Integer minBedrooms, Integer maxPrice, Integer minBathrooms,
      Double squareMeters) {
    return propertyRepository
        .findAll(PropertySpecification.withDynamicQuery(type, minBedrooms, maxPrice, minBathrooms, squareMeters));
  }
